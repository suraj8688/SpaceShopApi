    ...
    public partial class SeedDemoData : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(@"
                ...
                insert into Users(Username,Password, PasswordKey,LastUpdatedOn,LastUpdateedBy)
                select 'Demo',
                ...
                insert into PropertyTypes(Name,LastUpdatedOn,LastUpdateedBy)
                ...
                insert into FurnishingTypes(Name, LastUpdatedOn, LastUpdateedBy)
                ...
                Insert into Cities(Name,LastUpdateedBy,LastUpdatedOn,Country)
                ...
                Address2,CityId,FloorNo,TotalFloors,ReadyToMove,MainEntrance,Security,Gated,Maintenance,EstPossessionOn,Age,Description,PostedOn,PostedBy,LastUpdatedOn,LastUpdateedBy)
                select 
                1, --Sell Rent
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(@"
                ...
                delete from PropertyTypes where LastUpdateedBy=@UserID
                delete from FurnishingTypes where LastUpdatedBy=@UserID
                delete from Cities where LastUpdateedBy=@UserID
